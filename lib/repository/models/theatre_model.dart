...
class TheatreModel {
  ...
  TheatreModel({
    ...
    this.fullAddress = 'Gopikrishna, Kathmandu, Nepal',
    this.timings = const [
      '08:00 AM',
      '10: 00 AM',
      '1:30 PM',
  ...
  TheatreModel copyWith({
    ...
    return TheatreModel(
      ...
      facilities: facilites ?? this.facilities,
      fullAddress: fullAddress ?? this.fullAddress,
      timings: timings ?? this.timings,
      availableScreens: avalableScreens ?? this.availableScreens,
    );
  }
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      'timings': timings,
      'avalableScreens': availableScreens,
    };
  }
  ...
  factory TheatreModel.fromMap(Map<String, dynamic> map) {
    return TheatreModel(
      ...
      facilities: List<String>.from(map['facilites']),
      fullAddress: map['fullAddress'] ?? '',
      timings: List<String>.from(map['timings']),
      availableScreens: List<String>.from(map['avalableScreens']),
    );
  }
  ...
  @override
  String toString() {
    return 'TheatreModel(id: $id, name: $name, coordinates: $coordinates, facilites: $facilities, fullAddress: $fullAddress, timings: $timings, avalableScreens: $availableScreens,)';
  }
